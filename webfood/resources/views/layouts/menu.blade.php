            ...
            <div class="navbar-nav mx-auto">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0 bg-secondary rounded-0">
                        ...
                        <a href="{{ route('error') }}" class="dropdown-item {{ $page == 'error' ? 'active' : '' }}">404
                            Page</a>
                    </div>
                </div>
            ...
            <div class="d-flex m-3 me-0 align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu ms-auto dropdown-user" aria-labelledby="userDropdown">
                        ...
                        @else
                        <li>
                            <div disable class="dropdown-item">User : {{ Auth::user()->firstName }}
                                {{ Auth::user()->lastName }}</div>
                        </li>
                        <li><a class="dropdown-item" href="{{ route('inforUser') }}">Infomation</a></li>
                        <li><button class="dropdown-item" type="submit" form="logout">{{ __('Log out') }}</button></li>
